            ...
            val baseline =
                listOf(
                    ...
                    ChampionProfile(
                        ...
                        ccRating = CrowdControlRating(1.8, true, CcTier.MODERATE),
                        durability = DurabilityProfile(7.2, TankinessTier.BRUISER),
                        radar = FiveDimensionRadar(8.5, 7.5, 5.0, 6.0, 7.5),
                        powerSpike = PowerSpikeCurve.MID_GAME_SPIKE,
                        tags = setOf(ChampionTag.DIVER, ChampionTag.SKIRMISHER),
                    ),
                    ChampionProfile(
                        championId = "Gnar",
                        displayName = "Gnar",
                    ...
                    ChampionProfile(
                        ...
                        secondaryRoles = setOf(Role.JUNGLE, Role.TOP),
                    ...
                    ChampionProfile(
                        ...
                        secondaryRoles = setOf(Role.MID),
                        damageProfile = DamageProfile(0.85, 0.15, 0.0, DamageType.PHYSICAL),
                        ccRating = CrowdControlRating(0.5, false, CcTier.LIGHT),
                        durability = DurabilityProfile(3.8, TankinessTier.SQUISHY),
                        radar = FiveDimensionRadar(7.5, 5.0, 5.0, 8.5, 8.8),
                        powerSpike = PowerSpikeCurve.LATE_GAME_SPIKE,
                        tags = setOf(ChampionTag.MARKSMAN, ChampionTag.POKE, ChampionTag.HYPER_CARRY),
                    ),
                    ChampionProfile(
                        championId = "Smolder",
                        displayName = "Smolder",
                        primaryRole = Role.BOT,
                        secondaryRoles = setOf(Role.MID),
                        damageProfile = DamageProfile(0.65, 0.20, 0.15, DamageType.PHYSICAL),
                        ccRating = CrowdControlRating(0.5, false, CcTier.LIGHT),
                        durability = DurabilityProfile(3.5, TankinessTier.SQUISHY),
                        radar = FiveDimensionRadar(6.0, 4.5, 5.0, 8.0, 9.8),
                        powerSpike = PowerSpikeCurve.HYPER_SCALING,
                        tags = setOf(ChampionTag.MARKSMAN, ChampionTag.HYPER_CARRY, ChampionTag.POKE),
                    ),
                    ChampionProfile(
                        championId = "Jinx",
                        displayName = "Jinx",
